...
int main() {
    ...
    std::vector<GemmDescriptor> impls = {
        ...
        { "CoarsingTiledGemm", launch_coarse_tiled_gemm },
        { "CoarsingPaddingTiledGemm", launch_coarse_padding_tiled_gemm },
        ...
        { "CoarsingZorderTiledGemm", launch_coarse_zorder_tiled_gemm },
        { "CoarsingDoubleBufferTiledGemm", launch_coarse_double_buffer_tiled_gemm },
        { "FinalTiledGemm", launch_final_tiled_gemm },
        { "FinalAsyncTiledGemm", launch_final_async_tiled_gemm },
        // 在这里添加你自己的 GEMM，例如：
